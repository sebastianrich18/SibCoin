...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      url: "https://rinkeby.infura.io/v3/7967861d9f614657b268b967b155dadb", // <---- YOUR INFURA ID! (or it won't work)

      //    url: "https://speedy-nodes-nyc.moralis.io/XXXXXXXXXXXXXXXXXXXXXXX/eth/rinkeby", // <---- YOUR MORALIS ID! (not limited to infura)

      accounts: ["a329b73db8b5b487396350e0303d572c7da05b77a834ca476d96ad62d2a72f3d"],
    },
    kovan: {
